 ...
 */
package com.ytjojo.databind.bindadapter;
...
import com.ytjojo.databind.annotation.BindingAdapter;
import com.ytjojo.databind.annotation.BindingMethod;
import com.ytjojo.databind.annotation.BindingMethods;
import com.ytjojo.databind.annotation.InverseBindingAdapter;
...
@BindingMethods({
        @BindingMethod(type = TextView.class, attribute = "autoLink", method = "setAutoLinkMask"),
        @BindingMethod(type = TextView.class, attribute = "drawablePadding", method = "setCompoundDrawablePadding"),
        @BindingMethod(type = TextView.class, attribute = "editorExtras", method = "setInputExtras"),
        @BindingMethod(type = TextView.class, attribute = "inputType", method = "setRawInputType"),
        @BindingMethod(type = TextView.class, attribute = "scrollHorizontally", method = "setHorizontallyScrolling"),
        @BindingMethod(type = TextView.class, attribute = "textAllCaps", method = "setAllCaps"),
        @BindingMethod(type = TextView.class, attribute = "textColorHighlight", method = "setHighlightColor"),
        @BindingMethod(type = TextView.class, attribute = "textColorHint", method = "setHintTextColor"),
        @BindingMethod(type = TextView.class, attribute = "textColorLink", method = "setLinkTextColor"),
        @BindingMethod(type = TextView.class, attribute = "onEditorAction", method = "setOnEditorActionListener"),
})
