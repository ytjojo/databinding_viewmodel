...
import com.databinding.tool.expr.StaticIdentifierExpr;
...
class ExpressionVisitor extends BindingExpressionBaseVisitor<Expr> {
    ...
    @Override
    public Expr visitAndOrOp(@NonNull BindingExpressionParser.AndOrOpContext ctx) {
        try {
            onEnter(ctx);
    ...
    @Override
    public Expr visitBinaryOp(@NonNull BindingExpressionParser.BinaryOpContext ctx) {
        try {
            onEnter(ctx);
            return mModel.math(ctx.left.accept(this), ctx.op.getText(), ctx.right.accept(this));
        } finally {
    ...
    @Override
    public Expr visitBitShiftOp(@NonNull BindingExpressionParser.BitShiftOpContext ctx) {
        try {
            onEnter(ctx);
    ...
    @Override
    public Expr visitInstanceOfOp(@NonNull BindingExpressionParser.InstanceOfOpContext ctx) {
        try {
            onEnter(ctx);
    ...
    @Override
    public Expr visitUnaryOp(@NonNull BindingExpressionParser.UnaryOpContext ctx) {
        try {
            onEnter(ctx);
