...
public class FieldAccessExpr extends MethodBaseExpr {
    ...
    public String getInvertibleError() {
        ...
        if (mGetter.setterName == null && mGetter.type == Callable.Type.METHOD) {
    ...
    public boolean isDynamic() {
        ...
        if (mGetter == null || mGetter.type == Callable.Type.METHOD) {
            return true;
        }
    ...
    public Expr resolveTwoWayExpressions(Expr parent) {
        ...
        SetterStore.BindingGetterCall getter = setterStore.getGetterCall(mName, targetClass, null, null);
        if (getter == null) {
