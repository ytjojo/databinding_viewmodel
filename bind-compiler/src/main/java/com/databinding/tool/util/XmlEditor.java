...
public class XmlEditor {
    ...
    public static String strip(File f, String newTag, String encoding) throws IOException {
        ...
        List<? extends XMLParser.ElementContext> childrenOfRoot = elements(root);
        ...
        for (XMLParser.ElementContext it : dataNodes) {
        ...
        for (XMLParser.AttributeContext attr : attributes(root)) {
        ...
        for (TagAndContext it : noTag) {
            XMLParser.ElementContext element = it.getContext();
