 ...
 * {@link android.databinding.DataBindingComponent} as the first parameter and may be an instance method with the
 * instance retrieved from the <code>DataBindingComponent</code>.
 *
 * @see DataBindingUtil#setDefaultComponent(android.databinding.DataBindingComponent)
